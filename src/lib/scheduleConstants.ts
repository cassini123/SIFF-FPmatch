...
export const TIME_MAPPING: Record<string, string[]> = {
  '9:00': ['09:00'],
  '10:30': ['10:00', '10:30'],
  '13:00': ['12:00', '13:00', '14:00', '15:00'],
  '15:30': ['15:30'],
  '18:30': ['17:00', '18:00', '18:30', '19:00'],
  '20:40': ['20:40'],
  '23:00': ['23:00', '23:30', '23:50'],
};

// 字幕员问卷时间段（7 档 × 5 天；排片表时间段从 Excel 表头动态读取）
export const SUBTITLER_TIME_SLOTS = ['9:00', '10:30', '13:00', '15:30', '18:30', '20:40', '23:00'];
